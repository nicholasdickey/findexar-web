...
export function AppWrapper({ children, 
  ...
  userId = userId || '';
  let sharedState = {userId,isMobile,params, params2, tp, tp2,findexarxid, sid,slug,view, tab,sessionid,league,team,player,setLeague,setTeam,setPlayer,setPagetype,setView,setTab,noUser,mode,setMode,pagetype,fbclid, utm_content,teamName,setUserId,setTeamName,setSid,setSlug};
