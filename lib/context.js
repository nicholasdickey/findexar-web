...
export function AppWrapper({ children, 
  ...
  let sharedState = {userId,isMobile,params, params2, tp, tp2,findexarxid, sid,view, tab,sessionid,league,team,player,setLeague,setTeam,setPlayer,setPagetype,setView,setTab,noUser,mode,setMode,pagetype,fbclid, utm_content,teamName,setUserId,setTeamName}
